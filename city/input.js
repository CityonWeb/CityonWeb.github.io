...
function setupCameraControls(mouseMode, view) {
  if (mouseMode && mouseMode == 'fps') {
    ...
    // gOrbitControls = new THREE.PointerLockControls(gCamera, view);
    ...
    gOrbitControls.zoomSpeed = 0.2;
    gOrbitControls.keyPanSpeed = 10.0;
    gOrbitControls.panSpeed = 0.3;
    gOrbitControls.rotateSpeed = 0.3;
  }
}
